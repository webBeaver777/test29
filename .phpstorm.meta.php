...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/webbeaver/Рабочий стол/temp/test29/public/storage' => 'string',
...
'filesystems.links./home/webbeaver/Рабочий стол/temp/test29/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.routes.api','l5-swagger.documentations.default.paths.use_absolute_path',
...
'l5-swagger.default.api','l5-swagger.default.docs','l5-swagger.default.asset','l5-swagger.default.oauth2_callback','sanctum.csrf-cookie','cars.index','cars.store',
'cars.show','cars.update','cars.destroy','brands.index','brands.store',
'brands.show','brands.update','brands.destroy','car-models.index','car-models.store',
'car-models.show','car-models.update','car-models.destroy',
'storage.local',);
